...
|198|218|Chapter 14 – Modular Arithmetic and the Multiplicative Cipher|10 O’Clock + 5 Hours = 3 O’Clock|Line 5 to 6|Whether or not it is 3 AM or 3PM depends on if the current time is 10 AM or 10 PM.|Whether or not it is 3 AM or 3PM depends on if the current time is 10 PM or 10 AM.|The latter should be consistent with the former.|
